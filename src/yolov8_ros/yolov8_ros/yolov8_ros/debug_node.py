...
from yolov8_msgs.msg import BoundingBoxCenter
from yolov8_msgs.msg import BoundingBoxCenterArray
...
class DebugNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # custom
        self._center_arr_pub = self.create_publisher(
            BoundingBoxCenterArray, "bbox_center2d_arr", 10)   
    ...
    def draw_box(self, cv_image: np.array, detection: Detection, color: Tuple[int]) -> np.array:
        ...
        return cv_image, box_msg.center.position.x, box_msg.center.position.y
    ...
    def detections_cb(self, img_msg: Image, detection_msg: DetectionArray) -> None:
        ...
        center_array = BoundingBoxCenterArray()
        ...
        for detection in detection_msg.detections:
            ...
            cv_image, x_center, y_center = self.draw_box(cv_image, detection, color)

            #<------------------custom------------------>
            center=BoundingBoxCenter()
            center.header= img_msg.header
            center.header.frame_id = 'velo_link'
            center.x_center = x_center
            center.y_center = y_center

            center_array.centers.append(center)
            center_array.header=img_msg.header
            center_array.header.frame_id = 'velo_link'
            #<------------------custom------------------>
        ...
        self._center_arr_pub.publish(center_array)
